			...
			{videoStatus ? (
				...
				<>
					<Video
						...
						posterSource={{
							uri: 'https://media.tenor.com/Qp72t2HFhA0AAAAC/tako-tentacult.gif',
						}}
						usePoster={true}
						posterStyle={{
							resizeMode: 'cover',
					...
					/>
					<View
						style={{ paddingHorizontal: 10, flex: 1, backgroundColor: '#000' }}
					>
										...
										<View style={{ paddingTop: 20 }}>
											...
											>
												<Text style={styles.description}>
													{cleanHTML(animeDetails.description)}
												</Text>
											</ReadMore>
											<Text
												style={{
											...
											>
												{animeDetails.genres?.map((item) => (
													<View key={`${item}1`} style={styles.genersContainer}>
														<Text key={item} style={styles.geners}>
															{item}
														</Text>
													</View>
												))}
											...
											>
												<Text style={{ fontFamily: 'pop-bold', color: '#fff' }}>
													Sub Or Dub:
												</Text>
												<Text
													style={{
